...
combinations = [
                [example.lcdm_shear_log_2params_posterior_flow, example.lcdm_shear_log_2params_prior_flow, example.posterior_chain_lcdm_shear, example.prior_chain_lcdm_shear],
                ...
                [example.lcdm_3x2_log_2params_posterior_flow, example.lcdm_3x2_log_2params_prior_flow, example.posterior_chain_lcdm_3x2, example.prior_chain_lcdm_3x2],

...
# text:
ax = g.subplots[0, 0]
ax.text(0.01, 1.05, 'b) DES Y1 3x2 WCDM', verticalalignment='bottom', horizontalalignment='left', fontsize=main_fontsize, transform=ax.transAxes)
...
# save:
g.fig.savefig(out_folder+'/figure_DES_WCDM_triangle_2.pdf')
